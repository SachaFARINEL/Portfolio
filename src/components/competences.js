        ...
        <>
            <Grid container justifyContent='center'>
                <Grid item md={8} xs={10}>
                    <h4 style={{ textAlign: 'center', fontSize: '1.4rem' }}>C1 - Gérer le patrimoine informatique </h4>
                    <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
                        ...
                        <AccordionDetails style={{ textAlign: 'center', fontSize: '1.4rem' }}>
                ...
                <Grid item md={8} xs={10}>
                    <h4 style={{ textAlign: 'center', fontSize: '1.4rem' }}>C2 - Répondre aux incidents et aux demandes d’assistance et d’évolution </h4>
                ...
                <Grid item md={8} xs={10}>
                    <h4 style={{ textAlign: 'center', fontSize: '1.4rem' }}>C3 - Développer la présence en ligne de l’organisation </h4>
                ...
                <Grid item md={8} xs={10}>
                    <h4 style={{ textAlign: 'center', fontSize: '1.4rem' }}>C4 - Travailler en mode projet </h4>
                ...
                <Grid item md={8} xs={10}>
                    <h4 style={{ textAlign: 'center', fontSize: '1.4rem' }}>C5 - Mettre à disposition des utilisateurs un service informatique </h4>
                ...
                <Grid item md={8} xs={10}>
                    <h4 style={{ textAlign: 'center', fontSize: '1.4rem' }}>C6 - Organiser son développement professionnel </h4>
